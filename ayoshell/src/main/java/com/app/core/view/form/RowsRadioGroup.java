...
/**
 * Created by qiaoliang on 2017/11/13.
 */

public class RowsRadioGroup extends RadioGroup {

    private static final String TAG = "RadioGroupEx";

    public RowsRadioGroup(Context context) {
        super(context);
    }

    public RowsRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
