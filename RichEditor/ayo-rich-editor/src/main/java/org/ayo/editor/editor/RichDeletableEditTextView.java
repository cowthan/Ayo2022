 ...
 */
public class RichDeletableEditTextView extends android.support.v7.widget.AppCompatEditText {
    public RichDeletableEditTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public RichDeletableEditTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RichDeletableEditTextView(Context context) {
        super(context);
    }
