...
package org.ayo.component.sample.permission.system.camera;
...
public class CameraPreviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mCamera == null || cameraInfo == null) {
            ...
            return inflater.inflate(R.layout.pm_fragment_camera_unavailable, null);
        }

        View root = inflater.inflate(R.layout.pm_fragment_camera, null);
    ...
    public static Camera getCameraInstance(int cameraId) {
        ...
        try {
            ...
            Log2.d(TAG, "Camera " + cameraId + " is not available: " + e.getMessage());
        }
