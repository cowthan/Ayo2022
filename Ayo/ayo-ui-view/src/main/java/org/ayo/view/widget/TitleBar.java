...
import org.ayo.view.LocalDisplay;
...
public class TitleBar extends FrameLayout{
	...
	private void init(){
		LayoutInflater.from(getContext()).inflate(R.layout.ayo_layout_title_bar, this, true);
	...
	private View generateRightButton(int id){
		...
		View v = View.inflate(getContext(), R.layout.ayo_layout_titlebar_right_btn, null);
	...
	public TitleBar titleColor2(int color){
		this.title_bar_tv_title.setTextColor(color);
		return this;
	}
