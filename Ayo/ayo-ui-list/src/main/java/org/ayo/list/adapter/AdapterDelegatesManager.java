...
public class AdapterDelegatesManager<T extends ItemBean> {
  ...
  public void onBindViewHolder(@NonNull final T items, final int position,
                               @NonNull final AyoViewHolder viewHolder, int viewType) {
    ...
    Log.e("adapter", "onBindViewHolder()    delate class: " + delegate.getClass().getSimpleName());
    ...
    viewHolder.root().setOnClickListener(new View.OnClickListener(){
      ...
      public void onClick(View v) {
        if(delegate.getOnItemClickCallback() != null){
          delegate.getOnItemClickCallback().onItemClick(null, viewHolder.root(), position, items);
        }
      }
    });
  }
