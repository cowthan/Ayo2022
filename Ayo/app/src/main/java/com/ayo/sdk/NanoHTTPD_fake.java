...
public class NanoHTTPD_fake
{
     ...
     */
    public NanoHTTPD_fake(int port, File wwwroot ) throws IOException
    {
        myTcpPort = port;
...
//    {
//        myOut.println( "NanoHTTPD_fake 1.25 (C) 2001,2005-2011 Jarno Elonen and (C) 2010 Konstantinos Togias\n" +
...
//        try
//        {
//            new NanoHTTPD_fake( port, wwwroot );
//        }
//        catch( IOException ioe )
//        {
    ...
    private class HTTPSession implements Runnable
    {
        ...
        private String saveTmpFile(byte[] b, int offset, int len)
        {
            ...
            if (len > 0)
            {
                ...
                try {
                    File temp = File.createTempFile("NanoHTTPD_fake", "", new File(tmpdir));
