...
public class HttpMainActivity extends AppCompatActivity implements Animator.AnimatorListener {
    Unbinder mUnbinder;
                ...
                switch ( item.getItemId() ) {
                    case R.id.test_menu1:
                        if ( !mApps.isEmpty() ) {
                            ...
                            Toast.makeText(HttpMainActivity.this, "暂无可删内容", Toast.LENGTH_SHORT).show();
                        }
                        break;
                }
                return false;
...
//                        Toaster.toastShort("拒绝过了都");
                        DialogHelper.showRationaleDialog(HttpMainActivity.this, shouldRequest);
                    }
                })
...
//                        }
//                        DialogHelper.showOpenAppSettingDialog(HttpMainActivity.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.http_item_menu, menu);//加载menu布局
        return true;
    }
    ...
    @Subscribe( tags = {@Tag( HttpConstants.RxBusEventType.POPUP_MENU_DIALOG_SHOW_DISMISS )} )
    public void onPopupMenuDialogDismiss(Integer type) {
        if ( type == HttpConstants.MSG_DIALOG_DISMISS ) {
            WebService.stop(this);
    ...
    void initRecyclerView() {
        ...
        RxBus.get().post(HttpConstants.RxBusEventType.LOAD_BOOK_LIST, 0);
    ...
    @Subscribe( thread = EventThread.IO, tags = {@Tag( HttpConstants.RxBusEventType.LOAD_BOOK_LIST )} )
    ...
    class AppshelfAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if ( viewType == 1 ) {
                View view = inflater.inflate(R.layout.http_empty_view, parent, false);
                return new EmptyViewHolder(view);
            } else {
                return new MyViewHolder(LayoutInflater.from(
                        HttpMainActivity.this).inflate(R.layout.http_layout_book_item, parent,
                        false));
            }
        }
...
//            holder.mTvAppInstall.setText(infoModel.getName());
                ...
                holder.mTvAppInstall.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        installApkFile(HttpMainActivity.this, new File(infoModel.getPath()));
                    }
                });
                holder.mTvAppDelete.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        delete(HttpMainActivity.this, infoModel.getPackageName());
                    }
                });
