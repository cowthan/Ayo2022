...
public class PopupMenuDialog {
    ...
    public PopupMenuDialog builder() {
        View view = LayoutInflater.from(context).inflate(
                R.layout.http_layout_popup_menu_dialog, null);
    ...
    @Subscribe(tags = {@Tag(HttpConstants.RxBusEventType.WIFI_CONNECT_CHANGE_EVENT)})
    ...
    void onWifiDisconnected() {
        ...
        mImgLanState.setImageResource(R.drawable.http_shared_wifi_shut_down);
    ...
    void onWifiConnecting() {
        ...
        mImgLanState.setImageResource(R.drawable.http_shared_wifi_enable);
    ...
    void onWifiConnected(String ipAddr) {
        ...
        mTxtAddress.setText(String.format(context.getString(R.string.http_address), ipAddr, HttpConstants.HTTP_PORT));
        mButtonSplitLine.setVisibility(View.GONE);
        mBtnWifiSettings.setVisibility(View.GONE);
    }
    ...
    void onDialogDismiss(DialogInterface dialog) {
        ...
        if (mUnbinder != null) {
            mUnbinder.unbind();
            RxBus.get().post(HttpConstants.RxBusEventType.POPUP_MENU_DIALOG_SHOW_DISMISS, HttpConstants.MSG_DIALOG_DISMISS);
