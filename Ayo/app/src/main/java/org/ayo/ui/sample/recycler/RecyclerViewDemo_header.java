...
public class RecyclerViewDemo_header extends MasterFragment{
    @Override
    ...
    public void refreshList(Activity a, RecyclerView recyclerView, int layoutManager,
        ...
        if(decore == R.id.rb_decore_none){
            ...
            currentItemDecor = new FinalGridItemDecoration(getActivity(), true);
            currentItemDecor2 = null;
        }
        ...
        headerView.setBackgroundResource(R.drawable.round_rect);
        headerView.setImageResource(R.drawable.lion);
    ...
    private static class MyAdapter2 extends RecyclerView.Adapter<MyViewHolder>{
    ...
    private static class MyAdapter extends BaseRecyclerAdapter<ItemBean, MyViewHolder>{
