...
public class PinnedHeaderExpandableListViewDemo extends BasePage implements
    ...
    public View getPinnedHeader() {
        View headerView = (ViewGroup) getActivity().getLayoutInflater().inflate(R.layout.pinned_group, null);
