package org.ayo.ui.sample.recycler.pinnedsection.adapter;
...
import org.ayo.list.pinned.FullSpanUtil;
import org.ayo.sample.R;
import org.ayo.ui.sample.recycler.pinnedsection.PinnedStockActivity;
...
public class StockAdapter extends BaseMultiItemQuickAdapter<StockEntity.StockInfo, BaseViewHolder> {
    ...
    public StockAdapter(List<StockEntity.StockInfo> data) {
        super(data);
        addItemType(StockEntity.StockInfo.TYPE_HEADER, R.layout.pinned_item_stock_header);
        addItemType(StockEntity.StockInfo.TYPE_DATA, R.layout.pinned_item_stock_data);
    }
    ...
    protected void convert(BaseViewHolder holder, StockEntity.StockInfo item) {
        switch (holder.getItemViewType()) {
            ...
            case StockEntity.StockInfo.TYPE_DATA:
                ...
                ssb.setSpan(new AbsoluteSizeSpan(PinnedStockActivity.dip2px(holder.itemView.getContext(), 13)), item.stock_name.length(), stockNameAndCode.length(),
                        Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
