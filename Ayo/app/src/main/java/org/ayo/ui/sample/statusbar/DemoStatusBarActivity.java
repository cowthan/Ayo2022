...
public class DemoStatusBarActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(null);
        setContentView(R.layout.status_bar_ac_demo);
        ...
        FragmentTransaction ft = DemoStatusBarActivity.this.getSupportFragmentManager().beginTransaction();
