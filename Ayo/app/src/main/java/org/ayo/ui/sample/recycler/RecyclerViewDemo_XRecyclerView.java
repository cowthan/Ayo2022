...
public class RecyclerViewDemo_XRecyclerView extends MasterFragment{
    @Override
    protected int getLayoutId() {
        return R.layout.frag_recycler_list_x;
    }

    @BindView(R.id.mRecyclerView) XRecyclerView mRecyclerView;
