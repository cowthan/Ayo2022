 ...
 */
public class DemoDbActivity extends AppCompatActivity {
    ...
    private DbManager getDB(){
        ...
        dbConfig.setDbDir(new File(AppCore.ROOT));
    ...
    private void testDB_query(){
        ...
        try {
            ...
            if(Lang.isEmpty(list)){
                ...
                Toast.makeText(this, list.size() + "条数据", Toast.LENGTH_SHORT).show();
