...
public class PaintSettingView extends LinearLayout {
    ...
    private void init(){
        ...
        form_stroke_style.notifyDataSetChanged(Lang.newArrayList("FILL", "STROKE", "FILL_AND_STROKE"));
        form_stroke_cap.notifyDataSetChanged(Lang.newArrayList("BUTT", "ROUND", "SQUARE"));
        form_stroke_join.notifyDataSetChanged(Lang.newArrayList("BEVEL", "MITER", "ROUND"));
