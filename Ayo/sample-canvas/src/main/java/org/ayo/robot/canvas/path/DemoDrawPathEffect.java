...
public class DemoDrawPathEffect extends AyoActivityAttacher {
    ...
    protected void onCreate2(View view, @Nullable Bundle bundle) {
        ...
        form_check_path_effect.notifyDataSetChanged(Lang.newArrayList("CornerPathEffect", "DiscretePathEffect", "DashPathEffect", "PathDashPathEffect"));
        ...
        form_radio_path_effect_group.notifyDataSetChanged(Lang.newArrayList("none", "ComposePathEffect", "SumPathEffect"));
