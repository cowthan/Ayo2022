...
import org.ayo.appsist.monitor.util.ProcessUtil;
...
public class MemoryMonitor {
    ...
    public boolean isRunningHeap(){
        return MemoryMonitor.getInstance().isRuning() && MemoryMonitor.getInstance().getType().equals(FloatCurveView.MEMORY_TYPE_HEAP);
    }

    public boolean isRunningPss(){
        return MemoryMonitor.getInstance().isRuning() && MemoryMonitor.getInstance().getType().equals(FloatCurveView.MEMORY_TYPE_PSS);
    }
}
