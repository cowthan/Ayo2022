package org.ayo.appsist.monitor.util;
...
public class MemoryUtil {
    ...
    public static DalvikHeapMem getAppDalvikHeapMem() {
        ...
        dalvikHeapMem.totalMem = Runtime.getRuntime().totalMemory() / 1024;
    ...
    public static long getMaxHeapSize(Context c){
        ActivityManager activityManager = (ActivityManager) c.getSystemService(Context.ACTIVITY_SERVICE);
        int memClass = activityManager.getMemoryClass() * 1000; //KB
        return memClass;
    }
}
