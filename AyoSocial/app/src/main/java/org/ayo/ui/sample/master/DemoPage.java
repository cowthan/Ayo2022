...
public class DemoPage extends DemoMenuFragment {
    ...
    public DemoInfo[] getDemoMenus() {
        ...
        return new DemoInfo[]{
                ...
                new DemoInfo("schema访问--standard模式", new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        startBrowser(getActivity(), "ayo://page/standard?page=org.ayo.ui.sample_divider.master.DemoFragment&haha=77880");
                    }
                }),
                new DemoInfo("schema访问--single task模式", new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        startBrowser(getActivity(), "ayo://page/singletask?page=org.ayo.ui.sample_divider.master.DemoFragment&haha=7ddg80");
                    }
                }),
                new DemoInfo("schema访问--single top模式", new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        startBrowser(getActivity(), "ayo://page/singletop?page=org.ayo.ui.sample_divider.master.DemoFragment&haha=4d880");
                    }
                }),
                new DemoInfo("schema访问--single instance模式", new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        startBrowser(getActivity(), "ayo://page/singleinstance?page=org.ayo.ui.sample_divider.master.DemoFragment&haha=sdfg3");
                    }
                }),
                new DemoInfo("schema访问--自定义模板Activity", new View.OnClickListener(){
                    @Override
                    public void onClick(View v) {
                        startBrowser(getActivity(), "ayo://page/custom1?page=org.ayo.ui.sample_divider.master.DemoFragment&haha=ccee1");
                    }
                }),
        };
    }
    ...
    public static void startBrowser(Context c, String url){
        if(!isValidUri(c, url)){
            Toaster.toastShort("找不到对应的Activity：" + url);
            return;
        }else{
            Toaster.toastShort(url);
        }
