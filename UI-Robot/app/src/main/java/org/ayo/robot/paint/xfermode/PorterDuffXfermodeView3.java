...
public class PorterDuffXfermodeView3 extends BaseProterDuffView {
    public PorterDuffXfermodeView3(Context context) {
        super(context);
        init();
    }

    public PorterDuffXfermodeView3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PorterDuffXfermodeView3(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PorterDuffXfermodeView3(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
