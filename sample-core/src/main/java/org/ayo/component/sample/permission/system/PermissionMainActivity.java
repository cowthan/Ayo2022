...
package org.ayo.component.sample.permission.system;
...
import org.ayo.component.sample.permission.SampleActivityBase;
import org.ayo.component.sample.permission.logger.Log2;
import org.ayo.component.sample.permission.logger.LogFragment;
import org.ayo.component.sample.permission.logger.LogWrapper;
import org.ayo.component.sample.permission.logger.MessageOnlyLogFilter;
import org.ayo.component.sample.permission.system.camera.CameraPreviewFragment;
import org.ayo.component.sample.permission.system.contacts.ContactsFragment;
 ...
 * <p>
 * (This class is based on the PermissionMainActivity used in the SimpleFragment sample template.)
 */
public class PermissionMainActivity extends SampleActivityBase
        implements ActivityCompat.OnRequestPermissionsResultCallback {

    public static final String TAG = "PermissionMainActivity";
    ...
    // Whether the Log2 Fragment is currently shown.
    ...
    public void showCamera(View view) {
        Log2.i(TAG, "Show camera button pressed. Checking permission.");
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ...
            Log2.i(TAG,"CAMERA permission has already been granted. Displaying camera preview.");
            showCameraPreview();
        }
    ...
    private void requestCameraPermission() {
        Log2.i(TAG, "CAMERA permission has NOT been granted. Requesting permission.");
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.CAMERA)) {
            ...
            Log2.i(TAG, "Displaying camera permission rationale to provide additional context.");
    ...
    public void showContacts(View v) {
        Log2.i(TAG, "Show contacts button pressed. Checking permissions.");
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_CONTACTS)
            ...
            Log2.i(TAG, "Contact permissions has NOT been granted. Requesting permissions.");
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mLayout, R.string.permission_contacts_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(PermissionMainActivity.this, PERMISSIONS_CONTACT,
                                            REQUEST_CONTACTS);
                        }
                    })
                    .show();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CAMERA) {
            ...
            Log2.i(TAG, "Received response for Camera permission request.");

            // Check if the only required permission has been granted
            if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                // Camera permission has been granted, preview can be displayed
                Log2.i(TAG, "CAMERA permission has now been granted. Showing preview.");
                Snackbar.make(mLayout, R.string.permision_available_camera,
                        Snackbar.LENGTH_SHORT).show();
            } else {
                Log2.i(TAG, "CAMERA permission was NOT granted.");
            ...
            Log2.i(TAG, "Received response for contact permissions request.");
            ...
            if (PermissionUtil.verifyPermissions(grantResults)) {
                ...
                Log2.i(TAG, "Contacts permissions were NOT granted.");
                Snackbar.make(mLayout, R.string.permissions_not_granted,
                        Snackbar.LENGTH_SHORT)
                        .show();
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.pm_main, menu);
        return true;
    }
    ...
    public void initializeLogging() {
        ...
        // Using Log2, front-end to the logging chain, emulates android.util.log method signatures.
        Log2.setLogNode(logWrapper);
