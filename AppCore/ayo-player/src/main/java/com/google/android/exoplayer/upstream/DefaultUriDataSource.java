...
public final class DefaultUriDataSource implements UriDataSource {
  ...
  public DefaultUriDataSource(Context context, String userAgent, Map<String, String> headers) {
    this(context, null, headers, userAgent, true);
  }
  ...
  public DefaultUriDataSource(Context context, TransferListener listener,
                              Map<String, String> headers, String userAgent, boolean allowCrossProtocolRedirects) {
    this(context, listener, new DefaultHttpDataSource(userAgent, null, listener,
