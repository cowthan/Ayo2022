...
public class BlackEmpireView_v2 extends View {
    public BlackEmpireView_v2(Context context) {
        super(context);
        init();
    }

    public BlackEmpireView_v2(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BlackEmpireView_v2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BlackEmpireView_v2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
