...
public class CircularProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        strokeWidth = getResources().getDimension(R.dimen.default_stroke_width);
        backgroundStrokeWidth = getResources().getDimension(R.dimen.default_background_stroke_width);
