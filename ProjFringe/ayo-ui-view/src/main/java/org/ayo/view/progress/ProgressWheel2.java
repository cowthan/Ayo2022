...
public class ProgressWheel2 extends View {
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheel2_pwBarWidth, barWidth);
        rimWidth = (int) a.getDimension(R.styleable.ProgressWheel2_pwRimWidth, rimWidth);
        spinSpeed = (int) a.getDimension(R.styleable.ProgressWheel2_pwSpinSpeed, spinSpeed);
        barLength = (int) a.getDimension(R.styleable.ProgressWheel2_pwBarLength, barLength);

        delayMillis = a.getInteger(R.styleable.ProgressWheel2_pwDelayMillis, delayMillis);
        if (delayMillis < 0) { delayMillis = 10; }

        // Only set the text if it is explicitly defined
        if (a.hasValue(R.styleable.ProgressWheel2_pwText)) {
            setText(a.getString(R.styleable.ProgressWheel2_pwText));
        }

        barColor = a.getColor(R.styleable.ProgressWheel2_pwBarColor, barColor);
        textColor = a.getColor(R.styleable.ProgressWheel2_pwTextColor, textColor);
        rimColor = a.getColor(R.styleable.ProgressWheel2_pwRimColor, rimColor);
        circleColor = a.getColor(R.styleable.ProgressWheel2_pwCircleColor, circleColor);
        contourColor = a.getColor(R.styleable.ProgressWheel2_pwContourColor, contourColor);

        textSize = (int) a.getDimension(R.styleable.ProgressWheel2_pwTextSize, textSize);
        contourSize = a.getDimension(R.styleable.ProgressWheel2_pwContourSize, contourSize);
