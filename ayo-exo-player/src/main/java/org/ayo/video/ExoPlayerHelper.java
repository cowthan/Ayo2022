...
public class ExoPlayerHelper implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *            {@link ExoPlayerHelper#onRenderers} should be invoked once the
         ...
         * {@link ExoPlayerHelper#onRenderers} or {@link ExoPlayerHelper#onRenderersError}
    ...
    public ExoPlayerHelper() {
        player = ExoPlayer.Factory.newInstance(RENDERER_COUNT, 1000, 15000);
     ...
     *
     * @param renderers Renderers indexed by {@link ExoPlayerHelper} TYPE_*
     *            constants. An individual element may be null if there do not
     *            exist tracks of the corresponding type.
     * @param bandwidthMeter Provides an estimate of the currently available
     *            bandwidth. May be null.
     */
    ...
    public void seekTo(long positionMs) {
        long seekPosition = player.getDuration() == ExoPlayer.UNKNOWN_TIME ? 0
                : Math.min(Math.max(0, positionMs), getDuration());
