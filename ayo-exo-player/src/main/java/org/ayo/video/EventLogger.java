 ...
 */
public class EventLogger implements ExoPlayerHelper.Listener, ExoPlayerHelper.InfoListener,
        ExoPlayerHelper.InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[ExoPlayerHelper.RENDERER_COUNT];
    }
    ...
    public void onVideoFormatEnabled(Format format, int trigger, long mediaTimeMs) {
        Log.d(TAG,
                "videoFormat [" + getSessionTimeString() + ", " + format.id + ", "
    ...
    public void onAudioFormatEnabled(Format format, int trigger, long mediaTimeMs) {
        Log.d(TAG,
                "audioFormat [" + getSessionTimeString() + ", " + format.id + ", "
                        + Integer.toString(trigger) + "]");
    }
    ...
    public void onAvailableRangeChanged(TimeRange availableRange) {
        ...
        Log.d(TAG, "availableRange [" + availableRange.isStatic() + ", "
                + availableRangeValuesUs[0] + ", " + availableRangeValuesUs[1] + "]");
    }
