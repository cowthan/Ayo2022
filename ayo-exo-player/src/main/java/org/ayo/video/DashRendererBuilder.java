...
/**
 * A {@link ExoPlayerHelper.RendererBuilder} for DASH.
 */
public class DashRendererBuilder implements ExoPlayerHelper.RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements
        ...
        private final ExoPlayerHelper player;
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    MediaDrmCallback drmCallback, ExoPlayerHelper player) {
            this.context = context;
            this.userAgent = userAgent;
            this.drmCallback = drmCallback;
            this.player = player;
        ...
        public void onSingleManifest(MediaPresentationDescription manifest) {
            ...
            if (manifest.dynamic && manifest.utcTiming != null) {
                UtcTimingElementResolver.resolveTimingElement(manifestDataSource,
                        manifest.utcTiming, manifestFetcher.getManifestLoadCompleteTimestamp(),
                        this);
            } else {
                buildRenderers();
            }
        ...
        public void onTimestampError(UtcTimingElement utcTiming, IOException e) {
            ...
            // Be optimistic and continue in the hope that the device clock is
            // correct.
            buildRenderers();
        }
        ...
        private void buildRenderers() {
            ...
            ChunkSampleSource videoSampleSource = new ChunkSampleSource(videoChunkSource,
                    loadControl, VIDEO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    ExoPlayerHelper.TYPE_VIDEO);
            TrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context,
                    videoSampleSource, MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT, 5000,
            ...
            ChunkSource audioChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    LIVE_EDGE_LATENCY_MS, elapsedRealtimeOffset, mainHandler, player);
            ChunkSampleSource audioSampleSource = new ChunkSampleSource(audioChunkSource,
                    loadControl, AUDIO_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    ExoPlayerHelper.TYPE_AUDIO);
            ...
            ChunkSource textChunkSource = new DashChunkSource(manifestFetcher,
                    ...
                    LIVE_EDGE_LATENCY_MS, elapsedRealtimeOffset, mainHandler, player);
            ChunkSampleSource textSampleSource = new ChunkSampleSource(textChunkSource,
                    loadControl, TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
                    ExoPlayerHelper.TYPE_TEXT);
