...
/**
 * A {@link ExoPlayerHelper.RendererBuilder} for HLS.
 */
public class HlsRendererBuilder implements ExoPlayerHelper.RendererBuilder {
    ...
    private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url, ExoPlayerHelper player) {
            this.context = context;
            this.userAgent = userAgent;
            this.url = url;
            this.player = player;
        ...
        public AsyncRendererBuilder(Context context, String userAgent, String url,
                                    ExoPlayerHelper player, Map<String, String> headers) {
            this.context = context;
            this.userAgent = userAgent;
            this.url = url;
            this.player = player;
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player,
            ...
            renderers[ExoPlayerHelper.TYPE_METADATA] = id3Renderer;
            renderers[ExoPlayerHelper.TYPE_TEXT] = closedCaptionRenderer;
