...
import org.ayo.fragmentation.helper.internal.AnimatorHelper;
import org.ayo.fragmentation.helper.internal.LifecycleHelper;
import org.ayo.fragmentation.helper.internal.OnFragmentDestoryViewListener;
import org.ayo.fragmentation.helper.internal.ResultRecord;
import org.ayo.fragmentation.helper.internal.TransactionRecord;
...
public class SupportFragment extends Fragment implements ISupportFragment {
    ...
    private void dispatchSupportVisible(boolean visible) {
        ...
        if(visible){
            ///如果visible，即变成可见，先主Fragment调onSupportVisible，再子Fragment调
            if (visible) {
                if (mIsFirstVisible) {
            ...
            ///如果visible，即变成不可见，先子Fragment调onSupportInVisible，再主Fragment调
            if (!mNeedDispatch) {
                mNeedDispatch = true;
            } else {
                FragmentManager fragmentManager = getChildFragmentManager();
