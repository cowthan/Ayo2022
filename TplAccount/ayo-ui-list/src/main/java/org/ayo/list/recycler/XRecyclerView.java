...
public class XRecyclerView extends RecyclerView {
    ...
    private int mLoadingMoreProgressStyle = ProgressStyle.BallPulse;
...
//    protected OnScrollListener osc1111;
//
//    public void setOnScrollChangeListener2(OnScrollListener osc){
//        this.osc1111 = osc;
//    }
//
//    @Override
...
//        if(this.osc1111 != null) {
//            this.osc1111.onScrolled(this, dx, dy);
//        }
//    }
...
//        }
    ...
    public void setRefreshing(boolean refreshing) {
        if (refreshing && pullRefreshEnabled && mLoadingListener != null) {
            ...
            mRefreshHeader.onMove(LocalDisplay.dp2px(80)); //mRefreshHeader.getMeasuredHeight()得到的是0，你坑爹啊
            mLoadingListener.onRefresh();
        }

        try {
            //throw new RuntimeException("自动刷新会onMove一段距离，即header的距离，但这个距离写死了，是80dp");
        }catch (Exception e){
            e.printStackTrace();
        }
