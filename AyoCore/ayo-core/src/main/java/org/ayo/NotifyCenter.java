...
public class NotifyCenter {
    ...
    public void regist(Object tag, List<String> types, OnAlertChangeLisenter listener) {
    ...
    public void regist(Object tag, @NotifyType String type, OnAlertChangeLisenter listener) {
