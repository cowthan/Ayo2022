...
//        mOkHttpClient = okHttpClientBuilder.build();
    ...
    @Override
    public <T> void fire(final AyoRequest request, final BaseHttpCallback<T> callback, ProgressRequestListener progressRequestListener, ProgressResponseListener progressResponseListener) {
        init(request);
