...
public class PhotoView extends android.support.v7.widget.AppCompatImageView implements IPhotoView {
    ...
    public void setImageUrl(String url) {
        view_width = 886;// (int)
                         // DimensionPixelUtil.getDimensionPixelSize(DimensionPixelUtil.DIP,
                         // 886, myContext);
        view_height = 1182;// (int)
                           // DimensionPixelUtil.getDimensionPixelSize(DimensionPixelUtil.DIP,
                           // 1182, myContext);
        ImageRequest imageRequest = ImageRequestBuilder.newBuilderWithSource(MyUtils.parse(url))
                .setAutoRotateEnabled(true)
                .setResizeOptions(new ResizeOptions(view_width, view_height)).build();
        DraweeController controller = Fresco.newDraweeControllerBuilder()
                ...
                .setControllerListener(new BaseControllerListener<ImageInfo>() {
                    ...
                    public void onFinalImageSet(String s, @Nullable ImageInfo imageInfo,
                        ...
                        // view_width = (int)
                        // DimensionPixelUtil.getDimensionPixelSize(DimensionPixelUtil.DIP,
                        // imageInfo.getWidth(), myContext);
                        // view_height = (int)
                        // DimensionPixelUtil.getDimensionPixelSize(DimensionPixelUtil.DIP,
                        // imageInfo.getHeight(), myContext);
